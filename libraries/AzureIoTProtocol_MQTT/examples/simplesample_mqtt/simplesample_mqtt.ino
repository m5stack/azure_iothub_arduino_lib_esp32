...
static char ssid[] = "tzx";     // your network SSID (name)
static char pass[] = "12345678";    // your network password (use for WPA, or use as key for WEP)
...
void initTime() {
#if defined(ARDUINO_SAMD_ZERO) || defined(ARDUINO_SAMD_MKR1000) || defined(ARDUINO_SAMD_FEATHER_M0) || defined(ARDUINO_ARCH_ESP32)
#ifdef ARDUINO_SAMD_FEATHER_M0
